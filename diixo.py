...
diixo = [
    ...
    'nation', 'ness', 'never', 'ng', 'no', 'nope', 'not', 'none', 'nonexisten', 'nonempt',
    ...
    'diagnos', 'dis', 'discuss', 'miss', 'dispens', 'dispers', 'dispos', 'stress', 'gross', 'expos', 'express', 'guess', 'possib',
    ...
    'hyper', 'hash', 'gram', 'hard', 'ortho',
    'project', 'program', 'param', 'phone', 'tele', 'pow', 'excel', 'cell', 'produc', 'extra', 'extract', 'extrapolat', 'cancel',
    'micro', 'chip', 'mobil', 'system', 'control', 'comput', 'struct', 'view', 'bench', 'board', 'client', 'video',
    ...
    'dedicat', 'dupl', 'defic', 'delic', 'dict', 'dictat', 'difficult', 'effic', 'magnet', 'elicit', 'ergonom', 'evict',
    ...
    'portion', 'calcul', 'synth', 'suppl', 'tact', 'tactic', 'vict', 'vici', 'contact', 'synt', 'silicon', 'icon', 'respon',
    ...
    'check', 'defin', 'script', 'friend', 'reque', 'scop', 'frequen', 'infra', 'shell', 'action', 'activ', 'diffus', 'satisf',
    ...
    'vocat', 'valen', 'valenc', 'valent', 'pict', 'pictur', 'varianc', 'variat', 'variant', 'variabl', 'varie', 'vary', 'various',
    'univers', 'commun', 'unix', 'unit', 'unity', 'union', 'unique', 'interpolat', 'inten', 'operat', 'opinion', 'intern',
    ...
    'entr', 'entre', 'preneur', 'entrance', 'entrant', 'entrench', 'entreat', 'entrain', 'enter', 'entertain', 'enterpris',
    'accident', 'redundan', 'ready', 'already', 'affirm', 'refus', 'generat', 'region', 'regist', 'implement', 'implicit', 'implicat',
    ...
    'consol', 'counsel', 'crawl', 'culminat', 'cull', 'storag', 'creat', 'dangl', 'doubl', 'dwel', 'eclips', 'ecma', 'enabl',
    ...
    'mount', 'mistake', 'moment', 'ascend', 'mountain', 'motiv', 'approximat', 'approb', 'motion', 'emotion', 'deform',
    ...
    'immers', 'imminent', 'industr', 'indulg', 'induct', 'individual', 'disput', 'indent', 'incubat', 'increment',
    ...
    'wrap', 'other', 'bother', 'vocabular', 'rank', 'crank', 'shrank', 'cramp', 'drain', 'fair', 'fare', 'brave', 'ravel',
    ...
    'slot', 'slop', 'slim', 'slid', 'slic', 'slip', 'sponsor', 'split', 'splin', 'spontane', 'spread', 'speed',
    ...
    'granular', 'grace', 'grappl', 'grant', 'grand', 'gracious', 'disgrac', 'grate', 'gray',  'aboli', 'aggravat',
    ...
    'java', 'invit', 'includ', 'opportun', 'oppos', 'inclin', 'inclus', 'port', 'invocat', 'opponent', 'oppress',
    ...
    'stash', 'stock', 'statistic', 'stak', 'stay', 'stationar', 'station', 'status', 'steam', 'stead', 'stood', 'stat',
    'stud', 'stuff', 'week', 'subscrib', 'wedg', 'strength', 'strick', 'straggl', 'stout', 'story', 'dish', 'disdain',
    ...
    'octa', 'dub', 'dress', 'driv', 'drink', 'talk', 'tall', 'drag', 'engross', 'entitl', 'eradicat', 'litera', 'obliterat',
    ...
    'matur', 'matter', 'premier', 'four', 'splend', 'stair', 'chair', 'http', 'html', 'aim', 'air', 'conspir', 'fortif',
    'fac', 'tun', 'treat', 'cris', 'attribut', 'attract', 'intuit', 'intrusiv', 'inur', 'couth', 'fragil', 'aghast', 'outer',
    'agil', 'outrag', 'lonel', 'clog', 'relish', 'littl', 'ugl', 'benefit', 'fad', 'bent', 'bereav', 'bereft', 'fit', 'sorry',
    ...
    'vue', 'nam', 'cod', 'tour', 'tournament', 'edge', 'vulgar', 'accru', 'accus', 'ada', 'ful', 'glimps', 'plent', 'pledg',
    ...
    'mak', 'made', 'hav', 'has', 'haskell', 'captcha', 'hast', 'hassl', 'haunt', 'hunt', 'hurr', 'lodg', 'loose', 'lov', 'loud',
    ...
    'jealous', 'jet', 'jok', 'job', 'judg', 'kept', 'rais', 'diffiden', 'juggl', 'rain', 'rac', 'rad', 'brag', 'brac', 'boy',
    'surg', 'sync', 'surfac', 'surf', 'surmis', 'untaint', 'surpass', 'risk', 'rival', 'ris', 'rose', 'village', 'town', 'worr',
    'see', 'saw', 'seen', 'sees', 'sawed', 'sawn', 'noun', 'sav', 'gam', 'notorious', 'nought', 'gap', 'mile', 'smil', 'smell',
    'smok', 'mild', 'segue', 'send', 'sent', 'senior', 'sensation', 'seven', 'several', 'sever', 'shrink', 'shrunk', 'sigh',
    ...
    'begun', 'lead', 'leak', 'lect', 'leav', 'legend', 'lens', 'left', 'let', 'plead', 'leas', 'mat', 'lean', 'bleak', 'leaf',
    'deplet', 'replet', 'doat', 'liv', 'lik', 'til', 'hack', 'tight', 'drown', 'drunk', 'contr', 'drew', 'ear', 'eas', 'eat',
    'eager', 'near', 'dear', 'hex', 'sea', 'seal', 'who', 'whop', 'whither', 'why', 'peripher', 'wick', 'wide', 'perl', 'heter',
    ...
    'alex', 'amper', 'asham', 'ampl', 'aside', 'am', 'jam', 'always', 'flam', 'sdk', 'slack', 'skype', 'drank', 'temp', 'scream',
    ...
    'replenish', 'reput', 'reputa', 'rigid', 'star', 'pursu', 'receipt', 'tamper', 'tam', 'sue', 'steal', 'stale', 'stare',
    ...
    'exit', 'exhaust', 'your', 'youtube', 'yaml', 'wors', 'x86', 'x64', 'women', 'within', 'without', 'worship', 'won',
    ...
    'defunct', 'fathom', 'hatr', 'howbeit', 'insolv', 'horr', 'interior', 'intermitt', 'mince', 'nascen',
    'navigat', 'slain', 'candour', 'pdo', 'partner', 'spurn', 'spurious', 'sprung', 'spy', 'spyder', 'synopsis', 'testimonial',
    'terse', 'thumbnail', 'tore', 'torn', 'tri', 'trie', 'ios', 'incumben', 'operand', 'wavelet', 'chrome', 'review', 'repent',
    'compunction', 'con', 'coder', 'forbear', 'freelanc', 'cope', 'deject', 'dip', 'dim', 'din', 'exif', 'expo', 'era', 'evinc',
    'fed', 'fog', 'ordinal', 'per', 'perpetua', 'priz', 'prop', 'purg', 'pervas', 'propensit', 'que', 'prodd', 'uml', 'retort',
    'roi', 'role', 'sagac', 'sedat', 'swept', 'tomorrow', 'tone', 'torment', 'toss', 'totter', 'tray', 'tpu', 'treach',
    'trodden', 'trojan', 'tv', 'tues', 'voip', 'witt', 'tar', 'startup', 'prophe', 'renounc', 'renown', 'slit', 'translucen',
    'twilight', 'surveill', 'verac', 'shan', 'perchance', 'perennial', 'ring', 'wet', 'wel', 'wept', 'presid', 'preset',
    'precious', 'predat', 'pang', 'oath', 'nor', 'obj', 'ok', 'okay', 'pdf', 'patholog', 'premium', 'up', 'upsert', 'prize',
    'sought', 'strode', 'novitiat', 'occlusion', 'ocr', 'odious', 'our', 'sigmoid', 'lin', 'stole', 'stoke', 'straiv',
...
word_pieces = [
    ...
    "##ordinar", "##sampl", '##to', "##operat", "##ship", "##process", "##relat", "##tun", "##fortun", "##point", "##through",
    ...
    "##sponsor", "##stabl", "##stat", "##stead", "##stick", "##stop", "##stud", "##subscrib", "##substantiat", "##success", "##suit",
